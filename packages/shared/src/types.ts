...
// 사용 가능한 모델 목록
export const AVAILABLE_MODELS: Record<AiProviderName, { id: string; name: string; description: string }[]> = {
  openai: [
  ...
  perplexity: [
    { id: 'llama-3.1-sonar-large-128k-online', name: 'Sonar Large', description: 'Real-time web search' },
    { id: 'llama-3.1-sonar-small-128k-online', name: 'Sonar Small', description: 'Fast web search' },
    { id: 'llama-3.1-sonar-huge-128k-online', name: 'Sonar Huge', description: 'Most comprehensive' },
  ],
};
...
export const AI_PROVIDER_INFO: Record<AiProviderName, { displayName: string; description: string; color: string }> = {
  openai: {
    displayName: 'OpenAI',
